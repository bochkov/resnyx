...
public final class InputInvoiceMessageContent implements InputMessageContent {
    ...
    /**
     * Optional. Pass True if the user's phone number should be sent to provider. Ignored for payments in Telegram Stars.
     */
    @JsonProperty("send_phone_number_to_provider")
    private Boolean sendPhoneNumberToProvider;

    /**
     * Optional. Pass True if the user's email address should be sent to provider. Ignored for payments in Telegram Stars.
     */
