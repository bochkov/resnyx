...
public final class LoginUrl {
     ...
     * See <a href="https://core.telegram.org/widgets/login#setting-up-a-bot">Setting up</a> a bot for more details.
     * If not specified, the current bot's username will be assumed.
     * The url's domain must be the same as the domain linked with the bot.
     * See <a href="https://core.telegram.org/widgets/login#linking-your-domain-to-the-bot">Linking your domain</a>
